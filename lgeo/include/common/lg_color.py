...
lg_pearl_copper = Texture(
    Pigment(Color(rgb=Vector(147/255, 135/255, 103/255))),
    lg_pearl_finish,
)
...
lg_pearl_grey = Texture(
    Pigment(Color(rgb=Vector(171/255, 173/255, 172/255))),
    lg_pearl_finish,
)
...
lg_pearl_gold = Texture(
    Pigment(Color(rgb=Vector(215/255, 169/255, 75/255))),
    lg_pearl_finish,
)
