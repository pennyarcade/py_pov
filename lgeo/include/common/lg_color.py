...
lg_clear_blue = Texture(
 Pigment(Color(rgb=Vector(0/255, 32/255, 160/255>
  #if (lg_quality > 1)
   filter 0.9
  #end
 ),
...
lg_clear_green = Texture(
 Pigment(Color(rgb=Vector(6/255, 98/255, 50/255>
  #if (lg_quality > 1)
   filter 0.9
  #end
 ),
...
lg_clear_violet = Texture(
 Pigment(Color(rgb=Vector(100/255, 0/255, 97/255>
  #if (lg_quality > 1)
   filter 0.9
  #end
 ),
...
lg_clear_cyan = Texture(
 Pigment(Color(rgb=Vector(174/255, 239/255, 237/255>
  #if (lg_quality > 1)
   filter 0.9
  #end
 ),
...
lg_clear_neon_yellow = Texture(
 Pigment(Color(rgb=Vector(192/255, 255/255, 0/255>
  #if (lg_quality > 1)
   filter 0.85
  #end
 ),
...
lg_clear_yellow = Texture(
 Pigment(Color(rgb=Vector(202/255, 176/255, 0/255>
  #if (lg_quality > 1)
   filter 0.9
  #end
 ),
